...
#if canImport(midnight_sshFFI)
import midnight_sshFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_midnight_ssh_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_midnight_ssh_rustbuffer_free(self, $0) }
    }
}
...
private func uniffiCallbackInitFfiEventCallback() {
    uniffi_midnight_ssh_fn_init_callback_vtable_ffieventcallback(&UniffiCallbackInterfaceFfiEventCallback.vtable)
}
...
public func rshellConnect(config: FfiConnectConfig)throws  -> String {
    ...
    uniffi_midnight_ssh_fn_func_rshell_connect(
...
public func rshellDisconnect(connectionId: String) -> FfiResult {
    ...
    uniffi_midnight_ssh_fn_func_rshell_disconnect(
...
public func rshellDnsResolve(name: String, recordType: FfiDnsRecordType, perspectives: [String]) -> [FfiDnsAnswer] {
    ...
    uniffi_midnight_ssh_fn_func_rshell_dns_resolve(
...
public func rshellDoctorCollect(request: FfiDoctorCollectRequest)throws  -> FfiDoctorCollectionBundle {
    ...
    uniffi_midnight_ssh_fn_func_rshell_doctor_collect(
...
public func rshellDoctorPreview(request: FfiDoctorCollectRequest)throws  -> FfiDoctorCollectionPreview {
    ...
    uniffi_midnight_ssh_fn_func_rshell_doctor_preview(
        FfiConverterTypeFfiDoctorCollectRequest.lower(request),$0
    )
})
}
...
public func rshellExecuteCommand(connectionId: String, command: String) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_execute_command(
...
public func rshellForgetHostKey(host: String, port: UInt16) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_forget_host_key(
...
public func rshellGetProcesses(connectionId: String)throws  -> [FfiProcess] {
    ...
    uniffi_midnight_ssh_fn_func_rshell_get_processes(
        FfiConverterString.lower(connectionId),$0
    )
})
}
...
public func rshellGetSystemStats(connectionId: String)throws  -> FfiSystemStats {
    ...
    uniffi_midnight_ssh_fn_func_rshell_get_system_stats(
        FfiConverterString.lower(connectionId),$0
    )
})
}
public func rshellGitStatus(connectionId: String, repoPath: String)throws  -> FfiGitStatus {
    ...
    uniffi_midnight_ssh_fn_func_rshell_git_status(
        FfiConverterString.lower(connectionId),
...
public func rshellInit() -> Bool {
    ...
    uniffi_midnight_ssh_fn_func_rshell_init($0
    )
})
}
public func rshellKeychainDelete(kind: FfiCredentialKind, account: String) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_keychain_delete(
...
public func rshellKeychainIsSupported() -> Bool {
    return try!  FfiConverterBool.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_keychain_is_supported($0
    )
})
}
public func rshellKeychainList(kind: FfiCredentialKind) -> [String] {
    return try!  FfiConverterSequenceString.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_keychain_list(
...
public func rshellKeychainLoad(kind: FfiCredentialKind, account: String) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_keychain_load(
        FfiConverterTypeFfiCredentialKind.lower(kind),
        FfiConverterString.lower(account),$0
    )
})
...
public func rshellKeychainSave(kind: FfiCredentialKind, account: String, secret: String) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_keychain_save(
        FfiConverterTypeFfiCredentialKind.lower(kind),
...
public func rshellListeningPorts(connectionId: String)throws  -> [FfiListeningPort] {
    ...
    uniffi_midnight_ssh_fn_func_rshell_listening_ports(
        FfiConverterString.lower(connectionId),$0
    )
})
}
...
public func rshellPgCancel(connectionId: String, sessionId: String) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_pg_cancel(
        FfiConverterString.lower(connectionId),
...
public func rshellPgCloseQuery(connectionId: String, sessionId: String, cursorId: String) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_pg_close_query(
        FfiConverterString.lower(connectionId),
...
public func rshellPgConnect(config: FfiPgConfig)throws  -> String {
    ...
    uniffi_midnight_ssh_fn_func_rshell_pg_connect(
...
public func rshellPgDeleteRows(connectionId: String, sessionId: String, schema: String, table: String, rowIds: [String])throws  -> FfiPgUpdateResult {
    ...
    uniffi_midnight_ssh_fn_func_rshell_pg_delete_rows(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(sessionId),
...
public func rshellPgDescribeColumns(connectionId: String, schema: String, table: String)throws  -> [FfiPgColumnDetail] {
    ...
    uniffi_midnight_ssh_fn_func_rshell_pg_describe_columns(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(schema),
...
public func rshellPgDisconnect(connectionId: String) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_pg_disconnect(
        FfiConverterString.lower(connectionId),$0
    )
})
}
...
public func rshellPgExecute(connectionId: String, sessionId: String, sql: String, pageSize: UInt32)throws  -> FfiPgExecutionResult {
    ...
    uniffi_midnight_ssh_fn_func_rshell_pg_execute(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(sessionId),
...
public func rshellPgFetchPage(connectionId: String, sessionId: String, cursorId: String, count: UInt32)throws  -> FfiPgPageResult {
    ...
    uniffi_midnight_ssh_fn_func_rshell_pg_fetch_page(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(sessionId),
...
public func rshellPgInsertRow(connectionId: String, sessionId: String, schema: String, table: String, inputs: [FfiPgInsertColumn], returnColumns: [String])throws  -> FfiPgInsertedRow {
    ...
    uniffi_midnight_ssh_fn_func_rshell_pg_insert_row(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(sessionId),
        FfiConverterString.lower(schema),
        FfiConverterString.lower(table),
...
public func rshellPgListDatabases(connectionId: String)throws  -> [FfiPgDatabase] {
    ...
    uniffi_midnight_ssh_fn_func_rshell_pg_list_databases(
        FfiConverterString.lower(connectionId),$0
    )
})
}
public func rshellPgListRelations(connectionId: String, schema: String, database: String?)throws  -> [FfiPgRelation] {
    ...
    uniffi_midnight_ssh_fn_func_rshell_pg_list_relations(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(schema),
...
public func rshellPgListSchemaContents(connectionId: String, schema: String, database: String?)throws  -> FfiPgSchemaContents {
    ...
    uniffi_midnight_ssh_fn_func_rshell_pg_list_schema_contents(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(schema),
        FfiConverterOptionString.lower(database),$0
    )
...
public func rshellPgListSchemas(connectionId: String, database: String?)throws  -> [FfiPgSchema] {
    ...
    uniffi_midnight_ssh_fn_func_rshell_pg_list_schemas(
        FfiConverterString.lower(connectionId),
        FfiConverterOptionString.lower(database),$0
    )
})
...
public func rshellPgParquetAppend(writerId: UInt64, rows: [FfiPgRow])throws  {try rustCallWithError(FfiConverterTypeFfiPgError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_pg_parquet_append(
...
public func rshellPgParquetClose(writerId: UInt64)throws  {try rustCallWithError(FfiConverterTypeFfiPgError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_pg_parquet_close(
...
public func rshellPgParquetOpen(path: String, columns: [String])throws  -> UInt64 {
    ...
    uniffi_midnight_ssh_fn_func_rshell_pg_parquet_open(
...
public func rshellPgReleaseSession(connectionId: String, sessionId: String) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_pg_release_session(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(sessionId),$0
    )
})
...
public func rshellPgUpdateCell(connectionId: String, sessionId: String, schema: String, table: String, column: String, columnType: String, newValue: String?, rowId: String)throws  -> FfiPgUpdateResult {
    return try  FfiConverterTypeFfiPgUpdateResult.lift(try rustCallWithError(FfiConverterTypeFfiPgError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_pg_update_cell(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(sessionId),
        FfiConverterString.lower(schema),
        FfiConverterString.lower(table),
...
public func rshellPortForwardList(connectionId: String?) -> [FfiPortForwardStatus] {
    ...
    uniffi_midnight_ssh_fn_func_rshell_port_forward_list(
...
public func rshellPortForwardStart(config: FfiPortForwardConfig)throws  -> FfiPortForwardStatus {
    ...
    uniffi_midnight_ssh_fn_func_rshell_port_forward_start(
...
public func rshellPtyClose(connectionId: String, expectedGeneration: UInt64) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_pty_close(
        FfiConverterString.lower(connectionId),
...
public func rshellPtyResize(connectionId: String, cols: UInt32, rows: UInt32) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_pty_resize(
        FfiConverterString.lower(connectionId),
...
public func rshellPtyStart(connectionId: String, cols: UInt32, rows: UInt32) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_pty_start(
        FfiConverterString.lower(connectionId),
        FfiConverterUInt32.lower(cols),
        FfiConverterUInt32.lower(rows),$0
    )
...
public func rshellPtyWrite(connectionId: String, data: Data) -> FfiResult {
    return try!  FfiConverterTypeFfiResult.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_pty_write(
        FfiConverterString.lower(connectionId),
...
public func rshellSecurityPatchPreview(request: FfiSecurityPatchScanRequest)throws  -> FfiSecurityPatchScanPreview {
    ...
    uniffi_midnight_ssh_fn_func_rshell_security_patch_preview(
...
public func rshellSecurityPatchScan(request: FfiSecurityPatchScanRequest)throws  -> FfiSecurityPatchScanBundle {
    ...
    uniffi_midnight_ssh_fn_func_rshell_security_patch_scan(
        FfiConverterTypeFfiSecurityPatchScanRequest.lower(request),$0
    )
})
}
...
public func rshellSetEventCallback(callback: FfiEventCallback) {try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_set_event_callback(
...
public func rshellSftpCancel(transferId: String) -> Bool {
    return try!  FfiConverterBool.lift(try! rustCall() {
    uniffi_midnight_ssh_fn_func_rshell_sftp_cancel(
...
public func rshellSftpChgrp(connectionId: String, path: String, gid: String)throws  {try rustCallWithError(FfiConverterTypeSftpError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_sftp_chgrp(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(path),
...
public func rshellSftpChmod(connectionId: String, path: String, mode: String)throws  {try rustCallWithError(FfiConverterTypeSftpError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_sftp_chmod(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(path),
...
public func rshellSftpChown(connectionId: String, path: String, uid: String)throws  {try rustCallWithError(FfiConverterTypeSftpError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_sftp_chown(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(path),
...
public func rshellSftpCreateDir(connectionId: String, path: String)throws  {try rustCallWithError(FfiConverterTypeSftpError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_sftp_create_dir(
        FfiConverterString.lower(connectionId),
...
public func rshellSftpDeleteDir(connectionId: String, path: String)throws  {try rustCallWithError(FfiConverterTypeSftpError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_sftp_delete_dir(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(path),$0
    )
}
...
public func rshellSftpDeleteFile(connectionId: String, path: String)throws  {try rustCallWithError(FfiConverterTypeSftpError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_sftp_delete_file(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(path),$0
    )
}
...
public func rshellSftpDownload(transferId: String, connectionId: String, remotePath: String, localPath: String, expectedSize: UInt64)throws  -> UInt64 {
    ...
    uniffi_midnight_ssh_fn_func_rshell_sftp_download(
...
public func rshellSftpListDir(connectionId: String, path: String)throws  -> [FfiFileEntry] {
    ...
    uniffi_midnight_ssh_fn_func_rshell_sftp_list_dir(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(path),$0
    )
})
...
public func rshellSftpRename(connectionId: String, oldPath: String, newPath: String)throws  {try rustCallWithError(FfiConverterTypeSftpError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_sftp_rename(
        FfiConverterString.lower(connectionId),
...
public func rshellSftpResolveGid(connectionId: String, gid: String)throws  -> String {
    ...
    uniffi_midnight_ssh_fn_func_rshell_sftp_resolve_gid(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(gid),$0
    )
})
...
public func rshellSftpResolveUid(connectionId: String, uid: String)throws  -> String {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeSftpError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_sftp_resolve_uid(
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(uid),$0
    )
})
...
public func rshellSftpUpload(transferId: String, connectionId: String, localPath: String, remotePath: String)throws  -> UInt64 {
    return try  FfiConverterUInt64.lift(try rustCallWithError(FfiConverterTypeSftpError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_sftp_upload(
        FfiConverterString.lower(transferId),
        FfiConverterString.lower(connectionId),
        FfiConverterString.lower(localPath),
...
public func rshellSignalProcess(connectionId: String, pid: UInt32, signal: FfiSignal)throws  {try rustCallWithError(FfiConverterTypeMonitorError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_signal_process(
        FfiConverterString.lower(connectionId),
...
public func rshellTcpdumpStart(connectionId: String, interface: String, filter: String, snaplen: UInt32?)throws  -> UInt64 {
    ...
    uniffi_midnight_ssh_fn_func_rshell_tcpdump_start(
        FfiConverterString.lower(connectionId),
...
public func rshellTcpdumpStop(captureId: UInt64)throws  {try rustCallWithError(FfiConverterTypeFfiToolsError.lift) {
    uniffi_midnight_ssh_fn_func_rshell_tcpdump_stop(
...
private var initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_midnight_ssh_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_connect() != 61522) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_disconnect() != 61949) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_dns_resolve() != 48393) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_doctor_collect() != 54233) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_doctor_preview() != 51944) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_execute_command() != 16311) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_forget_host_key() != 7347) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_get_processes() != 29252) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_get_system_stats() != 17091) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_git_status() != 31272) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_init() != 12079) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_keychain_delete() != 62865) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_keychain_is_supported() != 42303) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_keychain_list() != 21343) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_keychain_load() != 33210) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_keychain_save() != 47196) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_listening_ports() != 14261) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_cancel() != 25236) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_close_query() != 14488) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_connect() != 4696) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_delete_rows() != 62342) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_describe_columns() != 19244) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_disconnect() != 255) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_execute() != 14560) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_fetch_page() != 57282) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_insert_row() != 57549) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_list_databases() != 8393) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_list_relations() != 7690) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_list_schema_contents() != 37779) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_list_schemas() != 65049) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_parquet_append() != 18238) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_parquet_close() != 29268) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_parquet_open() != 5804) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_release_session() != 9300) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pg_update_cell() != 1599) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_port_forward_list() != 38111) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_port_forward_start() != 54311) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_port_forward_status() != 9831) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_port_forward_stop() != 45593) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pty_close() != 40073) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pty_resize() != 42813) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pty_start() != 5576) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_pty_write() != 61400) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_security_patch_preview() != 9428) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_security_patch_scan() != 40328) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_set_event_callback() != 5907) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_cancel() != 23692) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_chgrp() != 15998) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_chmod() != 1425) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_chown() != 29712) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_create_dir() != 22334) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_delete_dir() != 18632) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_delete_file() != 32266) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_download() != 3069) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_list_dir() != 35615) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_rename() != 9713) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_resolve_gid() != 20006) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_resolve_uid() != 2329) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_sftp_upload() != 55454) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_signal_process() != 22786) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_tcpdump_start() != 32623) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_func_rshell_tcpdump_stop() != 5239) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_midnight_ssh_checksum_method_ffieventcallback_on_event() != 57565) {
        return InitializationResult.apiChecksumMismatch
    }
